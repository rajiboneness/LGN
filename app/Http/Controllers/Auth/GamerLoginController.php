...
class GamerLoginController extends Controller {
        ...
        if ( $request->playermobile == '' )
 {
        ...
        if ( $gamer>0 ) {
            ...
            $message = "Hi $fname,<br>
                You're receiving this email because you requested a password reset for your LetsGameNow Account. If you did not request this change, <br>you can safely ignore this email.<br>
