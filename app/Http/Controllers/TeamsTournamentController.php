...
class TeamsTournamentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.teams_tournament.index', compact('teamstournament', 'teamsplayers'));
    }
    public function teamname($id)
    {
        ...
        if ($tour->tournament_type == 1 )
        {
            ...
            else
            {
               ...
               $tournamentrooms = Tournament_rooms::where('tournament_rooms.is_deleted', 0)->where('tournament_rooms.tournament_id', $id)->select("tournament_rooms.*", "tournaments.name as tournaments")
                ...
                ->get();
            return view('admin.teams_tournament.index', compact('teamstournament', 'id', 'tournamentrooms'));
        }
        elseif ($tour->tournament_type == 2 )
        {
            ...
            return view('admin.teams_tournament.fifaindex', compact('teamstournament', 'id',  'tournamentrooms'));
        }
    ...
    public function changeteams($id)
    {
        ...
        return view('admin.teams_tournament.create', compact('teams', 'tournaments'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.teams_tournament.show', compact('teamstournament'));
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('admin.teams_tournament.edit', compact('teams', 'tournaments', 'teamstournament', 'teamsname', 'tournamentsname'));
    }
    /**
