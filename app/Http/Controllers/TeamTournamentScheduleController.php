...
class TeamTournamentScheduleController extends Controller {
    ...
    public function index() {
        ...
        return view( 'admin.team_tournament_schedule.index', compact( 'teamtournamentschedule' ) );
    }

    public function create() {
        $tournaments = Tournaments::all();
        return view( 'admin.team_tournament_schedule.create', compact( 'tournaments' ) );
    }

    public function show( $id ) {

        $teamtournamentschedule = Team_tournament_schedule::find( $id );
        return view( 'admin.team_tournament_schedule.show', compact( 'teamtournamentschedule' ) );
    }
    ...
    public function edit( $id ) {
        ...
        return view( 'admin.team_tournament_schedule.edit', compact( 'team1', 'team2' ) );
    }
    ...
    public function add_teamschedule( $id ) {
        ...
        if ( $count == 1 ) {
            ...
            return view( 'admin.team_tournament_schedule.winner', compact( 'tours', 'tournament' ) );
        } elseif ( $count == 0 ) {
            return redirect( 'gamertournamentschedule-details/' . $id );
        } else {
            return view( 'admin.team_tournament_schedule.add_schedule', compact( 'count', 'tours', 'tournament' ) );
        }
    }
