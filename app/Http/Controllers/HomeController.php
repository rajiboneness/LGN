...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $totalreferrer = DB::select("select count(id) as count, reg_ref_code as referrer from gamers WHERE reg_ref_code IS NOT NULL GROUP BY reg_ref_code ORDER BY count(id) DESC");
