...
class __TwigTemplate_059414fba016f7dc137a53e723e0a6588164c4d05630707a7871ad039dbafb4b extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <fieldset id=\"fieldset_change_password\">
    ...
    ";
        ...
        ";
            ...
            echo "
        ";
            $___internal_a64ddecfac0ee22279799706ee31999f50ded1cb8c6394c10990b6ce22b4588c_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
            // line 57
            echo call_user_func_array($this->env->getFilter('notice')->getCallable(), [$___internal_a64ddecfac0ee22279799706ee31999f50ded1cb8c6394c10990b6ce22b4588c_]);
            // line 63
            echo "      </div>
    ";
        }
...
";
    ...
    {
        return new Source("", "server/privileges/change_password.twig", "/home/sites/vhosts/letsgamenow.com/public_html/public/pma/templates/server/privileges/change_password.twig");
    }
}
