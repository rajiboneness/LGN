                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" id="con"
                                 style="display:@if($tour_data->country_id != '0') block; @else none @endif">
                                    ...
                                    @if(isset($countries))
                                        @foreach($countries as $country)
                                            <option value="{{$country->id}}"
                                                    @if(isset($tour_data) && ($tour_data->country_id != '') && ($tour_data->country_id == $country->id)) selected="selected" @endif>{{$country->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                            <div class="form-group" id="regn"
                                 style="display:@if($tour_data->region_id != '0') block; @else none @endif">
                    ...
                    <div class="row" id="roomk" style="display:none;">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="max_players" id="max_players" class="form-control"
                                       autocomplete="off"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @foreach($station as $stn)
                                    <input type="checkbox" name="ps_number[]" value="{{$stn->id}}"
                                           @if(in_array($stn->id,$psn)) checked @endif/> {{$stn->name}} &nbsp;&nbsp;
                                    &nbsp;
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="partner" id="partner">
                                    <option value="lgn" {{ old("partner", $tour_data->partner) == "lgn" ? "selected" : "" }}>LGN</option>
