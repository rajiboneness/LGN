   ...
   <div class="sidebar-content">
      ...
      <div class="sidebar-user">
         <div class="card-body">
            <div class="media">
               <div class="mr-3">
                  <a href="#"><img src="{{url('new-theme/images/login_logo.png')}}" width="38" height="38" class="rounded-circle" alt=""></a>
               </div>
         ...
         <ul class="nav nav-sidebar" data-nav-type="accordion">
            ...
            <li class="nav-item nav-item-submenu">
               ...
               <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                  ...
                  <!-- <li class="nav-item"><a href="{{route('teamtournamentpoint.index')}}" class="nav-link">Team Tourament Point</a></li> -->
                  <!-- <li class="nav-item"><a href="{{route('teamtournamentschedule.index')}}" class="nav-link">Team Tournament Schedule</a></li> -->
                  <li class="nav-item"><a href="{{route('tournamentrooms.index')}}" class="nav-link">All Tournament Rooms</a></li>
                  <li class="nav-item"><a href="{{route('gamertournamentschedule.index')}}" class="nav-link"> 
                     All Gamer Schedules</a>
                  </li>
            ...
            <li class="nav-item nav-item-submenu">
               <a href="#" class="nav-link"><i class="icon-user"></i> <span>Games Management</span></a>
               <ul class="nav nav-group-sub" data-submenu-title="Layouts">
