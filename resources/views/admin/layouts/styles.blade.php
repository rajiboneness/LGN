...
<head>
   <meta charset="utf-8">
   <link rel="icon" type="image/png" href="{{asset('new-theme/images/letsgamenow1.png')}}">
   ...
   <link href="{{ asset('new-theme/css/icons/icomoon/styles.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('new-theme/css/icons/fontawesome/styles.min.css') }}" rel="stylesheet" type="text/css">
 ...
 <script src="{{ asset('new-theme/ckeditor/ckeditor.js') }}"></script>
   ...
   <!-- DataTables -->
  <link rel="stylesheet" href="{{ asset('new-theme/datatables-bs4/css/dataTables.bootstrap4.css') }}">
   <!-- Core JS files -->
   ...
   <script src="{{ asset('new-theme/js/ckeditor.js') }}"></script>
   <script src="{{ asset('new-theme/js/jquery.js') }}"></script>
   ...
   <script src="{{ asset('new-theme/js/jquery_validator/jquery.validate.min.js') }}"></script>
   <script src="{{ asset('new-theme/js/jquery_validator/additional-methods.min.js') }}"></script>
   
   <!-- /theme JS files -->
   <!-- DataTables -->
<script src="{{ asset('new-theme/datatables/jquery.dataTables.js') }}"></script>
<script src="{{ asset('new-theme/datatables-bs4/js/dataTables.bootstrap4.js') }}"></script>
