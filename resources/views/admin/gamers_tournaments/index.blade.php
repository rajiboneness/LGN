      ...
      <div class="card-header header-elements-inline">
         ...
         <div class="header-elements">
            ...
            <div class="list-icons">
               ...
               <a href="{{ route('assignroomsingle',$id) }}" class="btn bg-teal-400 text-uppercase assign">Assign Room</a>
...
<div id="myModalroom" class="modal fade" role="dialog">
   <div class="modal-dialog">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form action="{{route('roomSchedulemail')}}" method="post" accept-charset="utf-8" onSubmit="return gamerSelectLimit();">
               @csrf 
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group">
