         ...
         <div class="header-elements">
            ...
            <div class="list-icons">
               ...
               <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal1" class="btn bg-teal-400 text-uppercase"><i class="fas fa-plus mr-1"></i>Send Email</a>
                ...
                <a href="{{ route('assignroomsingle',$id) }}" class="btn bg-teal-400 text-uppercase assign"><i class="fas fa-plus mr-1"></i>Assign Room</a>
               ...
               <div class="row">           
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                      ...
                      <label>Room Id : <em>*</em></label> <br>

                      <input type="text" name="room_id" id="room_id" class="form-control" autocomplete="off" required="required">

                      @if($errors->has('room_id'))

                      <span class="roy-vali-error"><small>{{$errors->first('room_id')}}</small></span>
