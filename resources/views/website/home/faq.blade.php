...
<section class="sponser_bg pt-5 pb-5">
  <div class="container">
    <div class="row">
      ...
      <div class="section__title" data-aos="fade-right" data-aos-easing="ease-in-back" data-aos-duration="1000">FAQs</div>
      <div>
       </div>
      @foreach($faqs as $faq)
      ...
      <div class="col-sm-12 about__area mt-3">
        <p>{{strip_tags(html_entity_decode($faq->question))}}?</p>
      </div>
      <div class="col-sm-12 about__area mt-3" >
        <p> Answer</p>
      </div>
