      ...
      <div class="container-fluid">
        <div class="row justify-content-end">
          <div class="col-sm-6 text-center p-3">
            ...
            <img src="{!!asset('letsgamenow/images/logo.png')!!}" class="mb-3" data-aos="fade-down" data-aos-duration="1000" width="100px"></a>
            <div class="login__block">
              <form id="tab-1" method="post" action="{{route('gamer.register.submit')}}" class="tab-content login__form current">
               @csrf
                <div class="row">
                  <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-duration="1000">
                      <input type="tel" name="mobile" value="" placeholder="Enter your Contact No" required="">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-duration="1000">
                      <input  name="dob" placeholder="Enter your DOB" type="text" onfocus="(this.type='date')" id="date" required="">
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="custom-control custom-checkbox text-left mb-3" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-duration="1000">
                  <input type="checkbox" id="customRadioInline1" name="customRadioInline1" class="custom-control-input" required="">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group justify-content-end">
                      <a href="{{route('home.login')}}" class="signin__btn" data-aos="fade-left" data-aos-duration="1000" data-aos-easing="ease-in-sine">Login Now</a>
                    </div>
                  </div>
                </div>
              </form>
