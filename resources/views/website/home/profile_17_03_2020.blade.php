            ...
            <div class="profile_details">
             ...
             {{ $team->team_name }}
              ...
              <div class="d-flex justify-content-between mb-3">
                <div class="add_game_id"><a data-toggle="modal" data-target="#addGameId" href="#addGameId">Add Game ID</a>  @if((Auth::guard('gamer')->user()->gamer_type == 2))
                 (Ingame name for Captain) @endif</div> 
...
<script>
    $(function () {
        $(document).on("click", ".btn-delete-submit", function () {
            var conf = confirm("Do you want to Delete this Player from you Team");
            if (conf) {                
