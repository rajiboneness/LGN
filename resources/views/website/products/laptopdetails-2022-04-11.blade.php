   ...
   @include("website.layouts.sub-header")
    ...
    <section class="product-listing py-4 py-lg-5 sponser_bg">
            ...
            <div><h3 class="text-light">Related Products</h3></div>
              <div class="row pt-4">
                @php
                  $relatedData = \App\Models\Product::where('product_category', 2)->take(16)->get();
                @endphp
                ...
                <div class="col-12 col-lg-3 col-sm-6 mb-3 mb-lg-4">
                  ...
                  <img src="{{URL::asset($ldata->image)}}" style="width:100%;">
                    ...
                    <h3 class="text-center">
                        <a href="{{ route('products.laptop-details',$ldata->id) }}">{{$ldata->title}}</a>
                      </h3>
                    </div>
                    <a href="{{ route('products.laptop-details',$ldata->id) }}" class="buy_btn">More Details <i class="fas fa-arrow-right"></i></a>
                    <div class="hover-div">
