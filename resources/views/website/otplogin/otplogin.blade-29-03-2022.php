          ...
          <div class="col-sm-6 text-center p-4 p-sm-5">
            ...
            <div class="login__block">
              ...
              <form class="login__form" method="post"onsubmit="return ValidateReqForm();" action="{{route('optloginpost')}}">
                ...
                <center><p style="color: white;text-align: center;">Or</p></center>
                <div class="row align-items-center">
                  <div class="col-sm-12">
                    <button type="button" class="" data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease-in-sine" onclick="fbLogin()" style="background-color: #3b5998;color: #fff;padding: 10px 48px;margin-bottom: 5px;border: 1px solid #3b5998;">Login With Facebook</button>
                    ...
                    <center><div id="gSignIn"></div></center>
                  </div> 
                </div> 
              </form>
