        ...
        <div class="row justify-content-end">
          <div class="col-sm-6 text-center p-3">
            ...
            <div class="login__block">
             <form id="tab-1" method="post" action="{{route('gamer.otplogin.submit')}}" class="tab-content login__form current">
               @csrf
                <div class="row">
                  <div class="col-sm-8">
                    <div class="form-group" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-duration="1000">
                      <input type="text" name="password" value="" placeholder="Enter your OTP " >
                      
                    </div>
                  </div>
                  <input type=hidden name ="email" value="{{$thisGamer->email}}">
                  <div class="col-sm-4">
