         ...
         <div class="col-sm-12 game_banner mb-5">
              ...
              <!-- AddToAny END -->
                  ...
                  <div class="col-sm-5 text-right ">
                     ...
                     <a href="javascript:void(0)" class="register__btn btn-register-submit" data-aos="fade-left" data-aos-easing="ease-in-back" data-aos-duration="1000" data-id="{{request()->route()->id}}" gamer_id="{{Auth::guard('gamer')->user()->id}}" gamer_type="{{$user}}"
                        >Register</a>  
                     <a href="#" class="play__btn" data-aos="fade-right" data-aos-easing="ease-in-back" data-aos-duration="1000">Lets Play</a>@endif
                  </div>
               </div>
               <hr>
            ...
            <div class="tournament_area mb-5">
               <div class="row">
                  <div class="col-sm-6">
                     ...
                     <p>{{strip_tags(html_entity_decode($tournaments->description))}}</p>
                     <h4>Rules</h4>           
                  <p>{{strip_tags(html_entity_decode(htmlspecialchars_decode(str_replace("&nbsp;", '',$tournaments->rulesdescription))))}}</p>
                     
                     <p>FOR ANY ISSUE CONTACT US ON CHAT WE ARE AVAILABLE 24/7(8013830894)</p>
                  </div>
                  <div class="col-sm-6" data-aos="fade-left" data-aos-easing="ease-in-back" data-aos-duration="1000">
                     <h5 class="leaderboard__name">Leadboard</h5>
            ...
            <div class="row align-items-center justify-content-between feature_area">
               ...
               <div class="col-sm-4 text-center" data-aos="zoom-in" data-aos-easing="ease-in-back" data-aos-duration="1000">
                  ...
                  <a href="#" class="white__btn">FIXTURE</a>
               </div>
            </div>
         </div>
      </div>
...
<script>
    $(function () {
        $(document).on("click", ".btn-register-submit", function () {
            var conf = confirm("Do you want to Register for this Tournament");
            if (conf) {                
