  ...
  {{--include styles--}}
   @include("website.layouts.sub-header")
    ...
    <section class="banner__area inner">
      <img src="{!! asset('new-theme\images\site banner\game.jpg')!!}" class="img-fluid">
    ...
    <section class="pt-5 pb-5">
      ...
      <div class="title__area light text-center">
      ...
      <div class="container-fluid mt-5">
        <div class="game__row">
          <ul class="game__list" data-aos="fade-up" data-aos-easing="ease-in-back" data-aos-duration="1000">
