          ...
          <li data-aos="zoom-in" data-aos-easing="ease-in-back" data-aos-duration="1000">
            <div class="news__blocks">
              <div class="news__blocks_img">
                <a class="d-block" href="{!! URL::to('news-details/'.$data->id.'/'.$key) !!}"><img src="{{URL::asset($data->image)}}" alt=""></a>
              </div>
              <div class="news__blocks__body">
                <a class="d-block mb-2" href="{!! URL::to('news-details/'.$data->id.'/'.$key) !!}">{{$data->title}}</a>
