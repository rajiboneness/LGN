          ...
          <div class="modal-content">
            <div class="modal-body" style="background-color: #202225;">
                <div class="coming_div">
                  <img src="https://letsgamenow.com/letsgamenow/images/logo.png" width="200px" style="margin-bottom: 30px;">
...
<li class="facebook"><a target="_blank" href="https://www.facebook.com/lgnindia/"><i class="fab fa-facebook-f"></i></a></li>
...
<li class="instagram"><a target="_blank" href="https://www.instagram.com/letsgamenow/"><i class="fab fa-instagram"></i></a></li>

<!-- <li class="linkedin"><a target="_blank" href="https://linkedin.com"><i class="fab fa-linkedin-in"></i></a></li> -->

<li class="youtube"><a target="_blank" href="https://www.youtube.com/channel/UCaiM9X1vtnILG3m8qS1wEYQ"><i class="fab fa-youtube"></i></a></li>
