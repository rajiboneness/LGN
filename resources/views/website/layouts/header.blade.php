<head>
    ...
    <title>{{ \App\Http\Controllers\SeoManagementController::getMetaTitle(Request::path(), 'meta_title') ?: "Lets Game Now" }}</title>
    <meta name="keywords" content="{{ \App\Http\Controllers\SeoManagementController::getMetaTitle(Request::path(), 'meta_keywords') ?: "Lets Game Now" }}">
    <meta name="description" content="{{ \App\Http\Controllers\SeoManagementController::getMetaTitle(Request::path(), 'meta_description') ?: "Lets Game Now" }}">
